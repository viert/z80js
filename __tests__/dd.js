...
test('Test dd00', () => {
  ...
  while (cpu.pc !== 0x3 && cpu.tStates < 12) {
    cpu.execInstruction()
  }
...
test('Test dd21', () => {
  ...
  while (cpu.pc !== 0x4 && cpu.tStates < 14) {
    cpu.execInstruction()
  }
...
test('Test dd26', () => {
  ...
  while (cpu.pc !== 0x3 && cpu.tStates < 11) {
    cpu.execInstruction()
  }
...
test('Test dd34', () => {
  ...
  while (cpu.pc !== 0x3 && cpu.tStates < 23) {
    cpu.execInstruction()
  }
...
test('Test dd36', () => {
  ...
  while (cpu.pc !== 0x4 && cpu.tStates < 19) {
    cpu.execInstruction()
  }
...
test('Test dd46', () => {
  ...
  while (cpu.pc !== 0x3 && cpu.tStates < 19) {
    cpu.execInstruction()
  }
...
test('Test dde1', () => {
  ...
  while (cpu.pc !== 0x2 && cpu.tStates < 14) {
    cpu.execInstruction()
  }
...
test('Test dde3', () => {
  ...
  while (cpu.pc !== 0x2 && cpu.tStates < 23) {
    cpu.execInstruction()
  }
...
test('Test dde9', () => {
  ...
  while (cpu.pc !== 0x25840 && cpu.tStates < 8) {
    cpu.execInstruction()
  }
...
test('Test ddfd00', () => {
  ...
  while (cpu.pc !== 0x4 && cpu.tStates < 16) {
    cpu.execInstruction()
  }
