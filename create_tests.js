...
for (let desc in tests) {
  ...
  `);
  testLines.push(
    `  expect(cpu.r1.af).toEqual(0x${hex16(data.output.regs.af)})`
  );
  testLines.push(
    `  expect(cpu.r1.bc).toEqual(0x${hex16(data.output.regs.bc)})`
  );
  testLines.push(
    `  expect(cpu.r1.de).toEqual(0x${hex16(data.output.regs.de)})`
  );
  testLines.push(
    `  expect(cpu.r1.hl).toEqual(0x${hex16(data.output.regs.hl)})`
  );
  testLines.push(
    `  expect(cpu.r2.af).toEqual(0x${hex16(data.output.regs.af2)})`
  );
  testLines.push(
    `  expect(cpu.r2.bc).toEqual(0x${hex16(data.output.regs.bc2)})`
  );
  testLines.push(
    `  expect(cpu.r2.de).toEqual(0x${hex16(data.output.regs.de2)})`
  );
  testLines.push(
    `  expect(cpu.r2.hl).toEqual(0x${hex16(data.output.regs.hl2)})`
  );
  testLines.push(
    `  expect(cpu.r1.ix).toEqual(0x${hex16(data.output.regs.ix)})`
  );
  testLines.push(
    `  expect(cpu.r1.iy).toEqual(0x${hex16(data.output.regs.iy)})`
  );
